            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="contact-table" class="table table-stripped">
                            <thead>
                                <tr>
                                    <th width="30">No</th>
                                    <th>Name</th>
            ...
            $('#modal-form form').validator().on('submit', function(e) {
                if(!e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        url: url,
                        type: "POST",
                        // data: $('#modal-form form').serialize(), // digunakan untuk non file
                        data: new FormData($('#modal-form form')[0]), //digunakan untuk file
                        contentType: false,                           //digunakan untuk file
                        processData: false,                           //digunakan untuk file
                        success: function($data) {
